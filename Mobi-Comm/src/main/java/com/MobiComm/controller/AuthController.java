...
public class AuthController {
    ...
    public ResponseEntity<?> sendOtp(@RequestBody Map<String, String> request) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(Map.of("message", "Error sending OTP", "error", e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> verifyOTP(@RequestBody Map<String, String> request) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(Map.of("message", "Error verifying OTP", "error", e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> getCurrentUser(@RequestHeader("Authorization") String token) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(Map.of("message", "Invalid token", "error", e.getMessage()));
        }
    }
}
